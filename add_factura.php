...
<body>
  ...
  <form id="frmDetalle" name="frmDetalle" action="detalle.php" method="post" >
    ...
    <input type="hidden" name="txtIdFacturacion" id="txtIdFacturacion" value=""/>
                        ...
                        <hr>
                          <div class="row">
                                      ...
                                      <div class="col-lg-2">
                                            <div id="demo-dp-component">
                                              <div class="input-group date">
                                                <input type="text" id="txtDateFactura" name="txtDateFactura" class="form-control"  value="<?php echo $Fecha_Factura; ?>">
                                      ...
                                      <div class="col-lg-2">
                                        <div id="demo-dp-component">
                                          <div class="input-group date">
                                            <input type="text" id="txtDateTentativa" name="txtDateTentativa" class="form-control"  value="<?php echo $Fecha_Factura; ?>">
                                            <span class="input-group-addon"><i class="fa fa-calendar fa-lg"></i></span>
                                          </div>
                                        </div>
                                      </div>
                                      ...
                                      <div class="col-lg-2">
                                            <div id="demo-dp-component">
                                              <div class="input-group date">
                                                <input type="text" id="txtDateRecepcion" name="txtDateRecepcion" class="form-control"  value="<?php echo $Fecha_Factura; ?>">
                                                <span class="input-group-addon"><i class="fa fa-calendar fa-lg"></i></span>
                                              </div>
                                            </div>
                                      </div>
                                              ...
                                              case 1:
                                                            $row .= "<div class=\"row\">
                                                                      <div class=\"col-md-3 checkbox\">
                                                                          <label class=\"form-checkbox form-icon active form-text\"><input type=\"checkbox\" value=\"$Email\"/>$Nombre</label>
                                                                      </div>";
                                                          $contandor = 2;
                                              break;
